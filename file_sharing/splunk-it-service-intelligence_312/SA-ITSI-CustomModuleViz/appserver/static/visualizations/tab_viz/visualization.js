	    ...
	    return SplunkVisualizationBase.extend({
	        ...
	        setupView: function() {
	            ...
	            var tabsView = new TabsView({
	                dash_script: '../visualization.js',
	                dash_stylesheet: '../visualization.css',
	                allowedRoles:[],
	                ...
	                tabSelector: new LaneTabRelationship({}, {
	                    ...
	                    itsiContext: this._fetchItsiContext()
	                })
	            });
	        },
	        ...
	        _fetchItsiContext: function () {
	            var tokens = mvc.Components.getInstance('default');
	            var contextFields = ['service_id', 'service_title', 'kpi_id', 'kpi_title'];
	            if (tokens.get('drilldown_payload')) {
	                var payload = JSON.parse(tokens.get('drilldown_payload'));
	                return _.pick(payload.context, contextFields);
	            }
	            else {
	                return _.pick(tokens.attributes, contextFields);
	            }
	        }
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
	    ...
	    var TabCollection = __webpack_require__(7);
	    var TabsView = __webpack_require__(10);
	    ...
	    var TabCollection = Backbone.Collection.extend({
	        ...
	        **/
	        initialize: function(models, options) {
	            console.log("TabCollection: initialize");
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
	    ...
	    **/
	    var TabsView = Backbone.View.extend({
	        ...
	        **/
	        initialize: function(options) {
	            console.log("TabsView: initialize");
	            this.collection = options.collection;
	        ...
	        **/
	        render: function() {
	            ...
	            // Could not use the trigger because could not access common.js (even though we're not in viz anymore (?!))
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
	    ...
	    return Backbone.Model.extend({
	        ...
	        **/
	        ...
	        fetch: function() {
	            // service_id is set from the payload when itsiTabModel is initialized. 
	            ...
	            var fetch_resolve = _.bind(function(response) {
	                // The ajax call could return an array or an object depending on
	                // where the request comes from, so convert it to object here.
	                if (_.isArray(response)) {
	                  this.serviceObj = _.first(response);
	                }
	                else{
	                ...
	                this._kpi_title = this.itsiContext.kpi_title;
	                dfd.resolve();
	            }, this);
